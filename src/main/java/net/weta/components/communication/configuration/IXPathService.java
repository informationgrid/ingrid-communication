...
public interface IXPathService {
     ...
     * 
     * @author  me
     * @param   String  nodePath    the path to the node that should be created
     * @throws  Exception   is thrown if parent node does not exist
     */
    void addNode(String nodePath) throws Exception;
    
    /**
     * addNode()
     * 
     * Appends a node to the document.
     * Would be the same like addNode(parentPath + "/" + elementName).
     * 
     * @author  me
